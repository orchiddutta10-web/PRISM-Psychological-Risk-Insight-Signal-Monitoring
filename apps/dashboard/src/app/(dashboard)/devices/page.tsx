  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg-main)', color: 'var(--text-primary)', padding: 24 }}>
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        ...
        <div className="card" style={{ padding: '24px', marginTop: '32px', borderRadius: '16px', border: '1px solid var(--border)' }}>
          <h3 style={{ margin: '0 0 12px 0', fontSize: '18px', fontWeight: 600, color: 'var(--text-primary)' }}>
            FAQ: How do I connect or pair a device?
          </h3>
          <p style={{ margin: '0 0 12px 0', fontSize: '14px', color: 'var(--text-secondary)', lineHeight: 1.6 }}>
            <strong>Why can&apos;t I pair my phone right now?</strong>
            <br />
            Currently, PRISM is operating as a <strong>localhost prototype</strong> designed for local evaluation, research, and demonstration purposes. Because it is not yet deployed to a public cloud server, the platform is only accessible from your current machine. Consequently, external devices (like your child&apos;s smartphone or smartwatch) cannot communicate with or pair to this local environment over the internet.
          </p>
          <p style={{ margin: 0, fontSize: '14px', color: 'var(--text-secondary)', lineHeight: 1.6 }}>
            <strong>When will pairing be available?</strong>
            <br />
            Once PRISM is officially deployed to a secure, HIPAA-compliant cloud environment in a future release, you will be able to easily pair mobile devices and wearables using a secure QR code or pairing link directly from this dashboard. For now, enjoy exploring PRISM&apos;s capabilities using the simulated Demonstration Mode!
          </p>
        </div>
