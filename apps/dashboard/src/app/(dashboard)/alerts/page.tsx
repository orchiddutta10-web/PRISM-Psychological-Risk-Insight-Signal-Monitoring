...
<<<<<<< HEAD
  AlertTriangle, CheckCircle, Info, RefreshCw, Check
} from 'lucide-react'
=======
    ...
    <div className="mx-auto max-w-5xl space-y-6 p-6 md:p-8">
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center py-24 text-gray-500 space-y-4">
          ...
          <div className="mt-8 inline-flex items-center gap-3 px-4 py-3 rounded-xl bg-blue-50 dark:bg-blue-500/10 border border-blue-100 dark:border-blue-500/20 text-blue-700 dark:text-blue-400 text-sm font-medium">
            <ShieldAlert size={16} />
            Tip: Use Demo Scenarios on the Overview page to generate real test alerts.
          </div>
        </div>
      ) : (
