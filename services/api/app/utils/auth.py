...
def verify_guardian_device_access(guardian: models.Guardian, device_id: str, db: Session):
...
class RoleChecker:
    ...
    def __call__(self, current_user: models.Guardian = Depends(get_current_user)) -> models.Guardian:
