...
def main():
    ...
    try:
        ...
        features = ["avg_active_mins_14d", "avg_sleep_hours_14d", "sleep_variance_14d", 
                    "active_variance_14d", "unlock_frequency_3d", "avg_hr_24h", "hr_variance_24h"]
        ...
        if df["is_anomalous"].nunique() > 1:
            ...
            if not anomalies.empty:
                ...
                response = companion.generate_response(q, sample.to_dict(orient='records')[0], context)
            ...
            print("Not enough variance in target label to train XGBoost classifier. All data points belong to one class.")
